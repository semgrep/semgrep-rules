...
class RegistryMetadataValidator(Draft7Validator):
    ...
    required_property_messages = {
        ...
        "likelihood": "Please include a 'likelihood' metadata field for security rules that is one of that is one of {self.likelihood_enum}, See https://semgrep.dev/docs/contributing/contributing-to-semgrep-rules-repository for more info.",
        "impact": "Please include a 'impact' metadata field for security rules that is one of that is one of {self.impact_enum}, See https://semgrep.dev/docs/contributing/contributing-to-semgrep-rules-repository for more info.",
        "confidence": "Please include a 'confidence' metadata field for security rules that is one of that is one of {self.confidence_enum}, See https://semgrep.dev/docs/contributing/contributing-to-semgrep-rules-repository for more info.",
        "subcategory": "Please include a 'subcategory' metadata field for security rules that is one of that is one of {self.subcategory_enum}, See https://semgrep.dev/docs/contributing/contributing-to-semgrep-rules-repository for more info.",
    }
