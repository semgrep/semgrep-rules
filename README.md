...
# >>> We're participating in [Hacktoberfest](https://hacktoberfest.digitalocean.com/)! Check out the [Hacktoberfest README](https://github.com/returntocorp/semgrep-rules/blob/develop/HACKTOBERFEST2021.md) <<<
