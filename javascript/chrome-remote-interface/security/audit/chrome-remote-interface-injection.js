...
async function example(userInput) {
    ...
    try {
        ...
        await Page.enable();
        // ok:chrome-remote-interface-navigate-injection
...
function example2(userInput) {
    CDP(async (client) => {
        ...
        try {
            ...
            // ok:chrome-remote-interface-setdocumentcontent-injection
...
async function example3(userInput) {
    ...
    try {
        ...
        // ok:chrome-remote-interface-evaluate-injection
...
function example5(userInput) {
    ...
    CDP(async (client) => {
        ...
        try {
            ...
            await Page.navigate({url: 'https://github.com'});
            await Page.loadEventFired();
            // ok:chrome-remote-interface-printtopdf-injection
