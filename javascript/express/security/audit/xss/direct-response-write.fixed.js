...
app.get('/2', function (req, res) {
    ...
    // ruleid: direct-response-write
    res.render('Response</br>' + user.name);
});
...
app.get('/xss', function (req, res) {
    ...
    // ruleid: direct-response-write
    res.render('Response</br>' + html);
});
app.get('/xss', function (req, res) {
    // ruleid: direct-response-write
    res.render('Response</br>' + req.query('doo'));
});
app.get('/xss', function (req, res) {
    // ruleid: direct-response-write
    res.render('Response</br>' + req.query.name);
});
