...
# Doing this because I want to parametrize the test functions.
# pytest's native parametrization only lets me do the cross product
# of repo x rules.
...
@pytest.mark.parametrize(
    "rule_path",
    list(filter(lambda path: get_language(path) == "{language}", all_rule_paths)),
